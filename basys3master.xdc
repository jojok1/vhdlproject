...
#set_property PACKAGE_PIN W16 [get_ports {bday1}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {bday1}]
#set_property PACKAGE_PIN W17 [get_ports {bday2}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {bday2}]
#set_property PACKAGE_PIN W15 [get_ports {bday3}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {bday3}]
...
set_property PACKAGE_PIN U1 [get_ports {bday1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bday1}]
set_property PACKAGE_PIN T1 [get_ports {bday2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bday2}]
set_property PACKAGE_PIN R2 [get_ports {bday3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bday3}]
...
set_property PACKAGE_PIN V7 [get_ports db]							
